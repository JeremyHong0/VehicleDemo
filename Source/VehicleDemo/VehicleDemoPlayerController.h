...
#include "VehicleDemoPlayerController.generated.h"

class UInputMappingContext;
class AVehicleDemoPawn;
class UVehicleDemoUI;
 ...
 */
UCLASS(abstract)
class VEHICLEDEMO_API AVehicleDemoPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AVehicleDemoPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UVehicleDemoUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UVehicleDemoUI> VehicleUI;
