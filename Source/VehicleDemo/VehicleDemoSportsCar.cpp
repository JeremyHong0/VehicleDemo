...
AVehicleDemoSportsCar::AVehicleDemoSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleDemoSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleDemoSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleDemoSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleDemoSportsWheelRear::StaticClass();
