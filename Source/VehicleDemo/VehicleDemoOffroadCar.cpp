...
#include "VehicleDemoOffroadCar.h"
#include "VehicleDemoOffroadWheelFront.h"
#include "VehicleDemoOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AVehicleDemoOffroadCar::AVehicleDemoOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UVehicleDemoOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UVehicleDemoOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UVehicleDemoOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UVehicleDemoOffroadWheelRear::StaticClass();
